        ...
        <View style={styles.container}>
            <View style={styles.profileContainer}>
                <View style={styles.profileTextContainer}>
                    ...
                    <Text style={styles.username}>@{profile?.email || profile?.username}</Text>
                </View>
                <Image
            ...
            <Text style={styles.bio}>{profile?.bio || "Ready to share my story with the world! 🌟"}</Text>
            <Text>
                {profile?.followersCount} • {profile?.websiteUrl || "https://www.example.com 🌐"}
            </Text>
